...
> Thank you for applying. ResideWell reviews applications weekly. If your experience and availability match upcoming class needs, we'll reach out within 7–10 business days to schedule a brief 15-minute video call. We appreciate your interest in resident wellness programming.

---

## Admin Notes (do not include in form)

- Export responses to a spreadsheet: Name, Formats, Availability, Rate, Insurance, Score
- Score using `instructor-screening-scorecard.md`
- Top candidates → 15-min video screen → trial class or reference check
